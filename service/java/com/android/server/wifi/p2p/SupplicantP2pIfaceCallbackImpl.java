...
class SupplicantVendorP2pIfaceCallbackV1_3 extends ISupplicantVendorP2PIfaceCallback.Stub {
    ...
    public SupplicantVendorP2pIfaceCallbackV1_3(String iface, WifiP2pMonitor monitor) {
        mInterface = iface;
        mMonitor = monitor;
    }
